...
public class PlayerWeaponsManager : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (activeWeapon)
        {
            ...
            {
                // if (hit.collider.GetComponentInParent<Damageable>()) simplify controller classes?
                if (hit.collider.GetComponentInParent<EnemyController>() || hit.collider.GetComponentInParent<Target>())  // to shoot bunnies that don't have all the robot AI controls
                {
