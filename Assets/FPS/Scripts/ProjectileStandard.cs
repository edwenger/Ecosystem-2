...
public class ProjectileStandard : MonoBehaviour
{
    ...
    bool IsHitValid(RaycastHit hit)
    {
        ...
        // ignore hits with triggers that don't have a hittableType component (e.g. Damageable)
        if (hit.collider.isTrigger && hit.collider.GetComponent(hittableType) == null)
        {
            return false;
        }
